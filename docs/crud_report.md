...
Код загружен в репозиторий GitHub по адресу https://github.com/wudroow/online-booking-db-variant-08. К работе приложены скриншоты страниц в папке images: список спортсменов, форма добавления спортсмена, список тренеров, форма редактирования тренера, список услуг, форма добавления услуги.
