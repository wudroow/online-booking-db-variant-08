...
### Подтверждение принятого pull request

Скриншот из интерфейса GitHub, подтверждающий, что первый pull request в репозиторий напарника был создан и успешно принят.

![Первый pull request принят](../images/first_pr.png)
